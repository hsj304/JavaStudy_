 ...
 * 		  저장 => 일반 기본형, 사용자졍의 클래스 => 기본적으로 설정 Object
 * 		  형변환
 * 		 =>주요기능
 ...
 * 				컬렉션(데이터를 쉽게 관리) => 10개 (자동으로 저장 공간이 설정)
 * 					Collection
 * 						|
 * 				-------------------------
 * 				|						|
...
public class 라이브러리_Calendar {
	public static void main(String[] args) {
		 ...
		 *  static => 클래스명.메소드명()
		 *  Math.random()
		 *  클래스명 객체명 = new 생성자() => 추상클래스 ,상속
		 *  -----			 ------
		 *  클래스명 객체명=메소드() => 추상클래스
		 *  
		 */
		cal.set(Calendar.YEAR, year);
		cal.set(Calendar.MONTH, month-1);//month => 0부터시작
